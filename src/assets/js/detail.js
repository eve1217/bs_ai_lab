...
window.addEventListener('load', () => {
  ...
  const project = new Project({
    ...
    setImgUrl(id) {
      ...
      return {
        pc01: `../../images/detail_${id}_01_pc${imgVer[id]?.pc01 ? imgVer[id].pc01 : ''}.jpg`,
        mo01: `../../images/detail_${id}_01_mo${imgVer[id]?.mo01 ? imgVer[id].mo01 : ''}.jpg`,
        pc02: `../../images/detail_${id}_02_pc${imgVer[id]?.pc02 ? imgVer[id].pc02 : ''}.jpg`,
        mo02: `../../images/detail_${id}_02_mo${imgVer[id]?.mo02 ? imgVer[id].mo02 : ''}.jpg`,
      };
    },
    renderHtml(data) {
